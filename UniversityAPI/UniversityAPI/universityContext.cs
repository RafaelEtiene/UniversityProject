...
namespace UniversityAPI
{
    public partial class universityContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=localhost;port=3306;database=university;uid=usr_rafiusk;pwd=rafa05", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.12-mysql"));
            }
        }
